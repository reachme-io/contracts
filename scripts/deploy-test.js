...
async function main() {
    ...
    // Flatten contracts
    const reachCmd = `npx hardhat flatten contracts/Reach.sol > Reach_Flattened.sol`;
    const authorityCmd = `npx hardhat flatten contracts/Authority.sol > Authority_Flattened.sol`;
